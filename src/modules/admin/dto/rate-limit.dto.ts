...
export class DeleteRateLimitQueryDto extends createZodDto(
  deleteRateLimitQuerySchema,
) {}
...
export type RateLimitRulesResponseType = z.infer<
  typeof RateLimitRulesResponseSchema
>;

export class RateLimitRulesResponseDto extends createZodDto(

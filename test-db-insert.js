...
var schema = require("./src/database/schema"); // adjust path as needed
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, db.insert(schema.feedbacks).values({
                            id: id,
                            userId: '19b5edbf-8014-4c6e-a25c-60edc16e4e1d', // use a valid user id from your DB
                            folderId: null,
                            content: 'test content',
                            sentiment: zod_schemas_1.FeedbackSentimentEnum.NEGATIVE,
                            confidence: 50,
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('Insert failed:', error_1);
                    return [3 /*break*/, 7];
